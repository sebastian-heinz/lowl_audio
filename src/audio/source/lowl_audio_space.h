...
namespace Lowl::Audio {
    ...
    private:
        ...
        uint32_t mixer_scratch_buffer_capacity;
        ...
        void drain_all_mixer_acks_locked();
        void drain_mixer_acks_locked(AudioBusHandle p_audio_bus_handle);
        ...
        AudioMixer *get_mixer_locked(AudioBusHandle p_audio_bus_handle);
        const AudioMixer *get_mixer_locked(AudioBusHandle p_audio_bus_handle) const;
        uint16_l get_mixer_owner_id_locked(AudioBusHandle p_audio_bus_handle) const;
        AudioPlaybackId find_playback_slot_id_by_mixer_handle_locked(AudioBusHandle p_audio_bus_handle,
                                                                     AudioMixerHandle p_mixer_handle) const;
        AudioBusId find_bus_slot_id_by_mixer_handle_locked(AudioBusHandle p_audio_bus_handle,
                                                           AudioMixerHandle p_mixer_handle) const;
        void map_playback_handle_locked(AudioBusHandle p_audio_bus_handle,
                                        AudioMixerHandle p_mixer_handle,
                                        AudioPlaybackId p_playback_slot_id);
        void unmap_playback_handle_locked(AudioBusHandle p_audio_bus_handle, AudioMixerHandle p_mixer_handle);
        void map_bus_handle_locked(AudioBusHandle p_audio_bus_handle, AudioMixerHandle p_mixer_handle, AudioBusId p_bus_id);
        void unmap_bus_handle_locked(AudioBusHandle p_audio_bus_handle, AudioMixerHandle p_mixer_handle);
